...
const NavBar = () => {
  ...
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost text-xl"> <img src={logo} alt="logo of the website"/> Gadget Heaven</a>
  </div>
  ...
  <div className="navbar-end">
    <a className="btn rounded-full mr-2"> <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="none"
            viewBox="0 0 24 24"
    ...
    <a className="btn rounded-full"> <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-5 w-5"
    fill="none"
    viewBox="0 0 24 24"
